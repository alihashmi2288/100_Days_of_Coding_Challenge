...
let unableToAttend:string = "Tahir";
//print unable to attend guest name
console.log(`Mr. ${unableToAttend} unable to attend dinner Tonight`);

//Replace the guest
let newGuest :string = "Ahmed Raza";
guest[guest.indexOf(unableToAttend)]= newGuest;

//new invitation
guest.forEach(invitation =>{
    console.log(`Dear ${invitation}, would you like to join me for dinner Tonight?`);
})