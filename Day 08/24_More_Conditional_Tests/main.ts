...
console.log("Equality Test 2: ", ("Ahmed" as string) === "ahmed");

//Tests for Inequality with strings
console.log("Inequality Test 1: ", ("Ahmed" as string)  != "ahmed");
console.log("Ineqaulity Test 2: ", ("Ahmed" as string) != "Ahmed");
...
console.log("Equality Numerical Test 2: ", (4 as number) === 5);

// Numerical tests involving inequality
console.log("Inequality Numberical Test 1: ", (4 as number) != 5);
console.log("Inequality Numberical Test 2: ", (4 as number) != 4);
...
console.log('Test 2 using "and" Operator: ' , ("ahmed" as string)=="Ahmed" && "raza"=="raza" );

//Tests using "or" operator
console.log('Test 1 using "or" Operator: ', "Ahmed" == "Ahmed" || "raza" == "raza");
console.log("Test 2 using 'or' Operator: ", "ahmed" == ("Ahmed" as string) || "raza"=="raza" );
console.log("Test 3 using 'or' Operator: ", "ahmed" == ("Ahmed" as string) || "Raza"==("raza" as string));

//Test whether an item is in a array
//create an array
let colorNames :string[] = ["Black", "White", "Yellow", "Blue"];
